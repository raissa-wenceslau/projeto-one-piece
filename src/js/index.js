...
botoes.forEach((botao, indice) => {
    ...
    //passo 3(1) - verificar se já existe um botão selecionado, se sim, devemos remover a seleção dele
        //const botaoSelecionado = document.querySelector(".botao.selecionado"); → refatorar
        //botaoSelecionado.classList.remove("selecionado"); → refatorar
        //refatorar (27 + 28) → extrair para function no escopo global
        desselecionarBotao();
    //passo 3(2) - verificar se já exista um personagem selecionado, se sim, devemos remover a seleção dele
        desselecionarPersonagem();

    //passo 2(1) - adicionar a classe "selecionado" no personagem que o usuário selecionou
...
//como é a função desselecionarBotao:
